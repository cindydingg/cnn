      ...
      for f in range(num_filts):
          for i in range(out_height):
              for j in range(out_width):
                  ...
                  dw[f] += xpad[n, :, h_start:h_end, w_start:w_end] * dout[n, f, i, j]
                  dxpad[n, :, h_start:h_end, w_start:w_end] += w[f] * dout[n, f, i, j]
      ...
      for c in range(C):
          for i in range(H_out):
              for j in range(W_out):
                  ...
                  max_mask = (pool_region == np.max(pool_region))

                  dx[n, c, h_start:h_end, w_start:w_end] += max_mask * dout[n, c, i, j]
  # ================================================================ #
  # END YOUR CODE HERE
  # ================================================================ # 
